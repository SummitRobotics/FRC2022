...
public enum LEDRange {
	...
	/**
	 * Atomic LED ranges, that make up the smallest segments of LED strip
	 * decomposition.
	 * They are the building blocks of LEDRanges, and they manage their own interal
	 * state to update LED colors.
	 */
	protected enum Atomic {
		...
		/**
		 * Attempts to replace the Atom's call with a new one. If the new call has
		 * higher priority, it is accepted.
		 * 
