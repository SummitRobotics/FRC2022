...
public class LEDCall implements LEDHandler {
	...
	/**
	 * The color generator function, which can be overloaded. By default it returns
	 * black
	 * 
	...
	/**
	 * Creates a new LEDCall with getColor overloaded. Makes all LEDs in its range
	 * one color.
	 * 
	...
	/**
	 * Creates a new LEDCall with getColor overloaded. Makes LEDs in its range flash
	 * between 2 colors at a set interval.
	 * 
	...
	/**
	 * Creates a new LEDCall with getColor overloaded. Makes LEDs in its range flash
	 * color ON, then color OFF, the color ON, then color OFF, then hold color ON.
	 * 
	...
	/**
	 * Creates a new LEDCall with getColor overloaded. Makes LEDs in its range do a
	 * wave?
	 * 
